    ...
    <div>
      ...
      <section className="py-16 px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/swedmass.jpg" alt="Swedish Massage" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
        ...
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/Aromatherapy.jpg" alt="Aromatherapy" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
        ...
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/deep.jpg" alt="Deep Tissue Massage" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
        ...
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/hotstone.png" alt="Hot Stone Massage" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
        ...
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/Shiatsu.jpg" alt="Shiatsu Massage" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
        ...
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/thaimass.jpg" alt="Thai Massage" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
        ...
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/prenatal.jpeg" alt="Prenatal Massage" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
        ...
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/reflexology.jpg" alt="Reflexology" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
        ...
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/sportsmass.jpg" alt="Sports Massage" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
        ...
        <div className="bg-card p-4 rounded-lg shadow">
          <img src="/img/trigger.jpg" alt="Trigger Point Massage" className="rounded-t-lg w-full h-auto" style={{ width: '1000px', height: '600px' }} />
